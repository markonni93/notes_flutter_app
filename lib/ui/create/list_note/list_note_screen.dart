...
import 'list_note_screen_viewmodel.dart';
import 'widgets/list_note_item.dart';

class CreateListNoteScreen extends StatefulWidget {
  const CreateListNoteScreen({super.key, required this.viewModel});

  final ListNoteScreenViewModel viewModel;

  @override
  State<CreateListNoteScreen> createState() => _CreateListNoteScreenState();
}

class _CreateListNoteScreenState extends State<CreateListNoteScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          leading: IconButton(
              onPressed: () async {
                await widget.viewModel.insertListNote(_listItems, "My title");
        ...
        body: AnimatedList(
          ...
          itemBuilder:
            ...
            return _buildItem(_listItems[index], index, animation, oddItemColor,
                evenItemColor);
          },
        ));
  }
